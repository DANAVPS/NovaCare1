    ...
    <div class="flex">
        <aside class="w-64 bg-white shadow-lg min-h-screen" style="height: calc(100vh - 64px);">
            <nav class="mt-5 px-2">
                ...
                <a href="/xampp/NovaCareCRM/public/index.php?action=autorizaciones" class="flex items-center px-4 py-3 text-gray-700 rounded-lg bg-primary text-white">Autorizaciones</a>
            </nav>
        </aside>
        ...
        <main class="flex-1 p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="/xampp/NovaCareCRM/public/index.php?action=autorizaciones" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition">← Volver</a>
            </div>
